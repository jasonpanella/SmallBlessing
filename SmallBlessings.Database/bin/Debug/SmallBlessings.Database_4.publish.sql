...
GO
/*
The column [dbo].[Person].[ChurchHomeFlag] on table [dbo].[Person] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
PRINT N'Rename refactoring operation with key 90366f45-4e96-44e5-92a6-1cd71d98297c is skipped, element [dbo].[Person].[ChurchHome] (SqlSimpleColumn) will not be renamed to ChurchHomeFlag';
...
ALTER TABLE [dbo].[Person]
    ADD [ChurchHomeFlag] BIT            NOT NULL,
        [ChurchHomeName] NVARCHAR (50)  NULL,
