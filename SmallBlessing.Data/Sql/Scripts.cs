...
namespace SmallBlessing.Data.Sql
{
    ...
    public static class Scripts
    {
        ...
        public static readonly string sqlGetDependentsById = "Select" +
            ...
            " From [Dependents] Where PersonID = @PersonID order by [BirthDate]";
        ...
        public static readonly string SqlGetAllClubMembersToExport = "Select" +
           ...
           " FROM Person" +
           " WHERE DATEDIFF(DAY,[DateUpdated],GETDATE()) <= @DaysToExport and ExportFlag = 0 and IsActive = 0";
        ...
        public static readonly string SqlGetPersonItems = "Select" +
            ...
            " FROM Items where PersonID = @PersonID and IsActive = 0 order by Date";
        ...
        //    " Items" +
        //    " where (PersonID = @PersonID)";
        //public static readonly string SqlDeleteItems = "Update Items set IsActive = 1 where (PersonID = @PersonID)";
        public static readonly string SqlDeleteItems = "Delete from Items where PersonID = @PersonID";
        ...
        public static readonly string SqlSearchPeople = "Select " +
            ...
            " From Person Where (@FirstName is null or FirstName like @FirstName) {0} (@LastName is null or LastName like @LastName) and IsActive = 0 order by LastName ";
